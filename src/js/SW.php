<?php
// Install must not bulk-fetch routes. Resources are cached only when requested.
$precacheAssets = [];
?>
const CACHE_NAME = 'phjs-titanium-auto-v23';
const PRECACHE_ASSETS = <?php echo json_encode($precacheAssets, JSON_UNESCAPED_SLASHES); ?>;
